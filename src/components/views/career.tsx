...
const KNOWN_BOARD_DOMAINS: Record<string, string> = {
  ...
  daraz: 'daraz.pk',
  // ── Pakistani companies where the naive slug→.com guess picks the
  //    wrong or parked domain — explicit wins over the guess ──
  cubix: 'cubix.co',
  vyro: 'vyro.pk',
  bazaar: 'bazaar.com.pk',
  'bazaar-technologies': 'bazaar.com.pk',
  airlift: 'airlift.com.pk',
  'airlift-technologies': 'airlift.com.pk',
  sastaticket: 'sastaticket.pk',
  priceoye: 'priceoye.pk',
  patari: 'patari.com.pk',
  addoai: 'addo.ai',
  'addo-ai': 'addo.ai',
  tezeract: 'tezeract.ai',
  nextbridge: 'nextbridge.org',
  venturedivelogic: 'venturedive.com',
  ...
  avanzasolutions: 'avanzasolutions.com',
  avanza: 'avanzasolutions.com',
  afiniti: 'afiniti.com',
  folio3: 'folio3.com',
  curemd: 'curemd.com',
  i2c: 'i2cinc.com',
  ...
  wateen: 'wateen.com',
  nisum: 'nisum.com',
  calibermind: 'calibermind.com',
  spglobal: 'spglobal.com',
  's-p-global': 'spglobal.com',
  vroozi: 'vroozi.com',
  contoursoftware: 'contoursoftware.com',
}
