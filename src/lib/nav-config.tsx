...
export const NAV_ITEMS: {
  ...
  short: string
  icon: ReactNode
  group: 'workspace' | 'knowledge' | 'system'
}[] = [
  ...
  { key: 'news', label: 'News Radar', short: 'Radar', icon: <Radar className="h-4 w-4" />, group: 'workspace' },
  { key: 'career', label: 'Career', short: 'Career', icon: <Briefcase className="h-4 w-4" />, group: 'workspace' },
  { key: 'mindmap', label: 'Mindmaps', short: 'Maps', icon: <Share2 className="h-4 w-4" />, group: 'workspace' },
  { key: 'flashcards', label: 'Flashcards', short: 'Cards', icon: <Layers className="h-4 w-4" />, group: 'workspace' },
  { key: 'analytics', label: 'Analytics', short: 'Stats', icon: <ChartLine className="h-4 w-4" />, group: 'workspace' },
